        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pages_Settings_SettingId",
                        column: x => x.SettingId,
                        principalTable: "Settings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "CreatedDate", "DeletedDate", "Name", "NormalizedName", "UpdatedDate" },
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 12, 31, 13, 59, 39, 903, DateTimeKind.Local).AddTicks(9718), null, "Admin", null, null },
                    { 2, null, new DateTime(2023, 12, 31, 13, 59, 39, 903, DateTimeKind.Local).AddTicks(9729), null, "Moderator", null, null },
                    { 3, null, new DateTime(2023, 12, 31, 13, 59, 39, 903, DateTimeKind.Local).AddTicks(9730), null, "User", null, null }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "BirthDate", "ConcurrencyStamp", "CreatedDate", "DeletedDate", "Email", "EmailConfirmed", "FirstName", "IsActive", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "Password", "PasswordHash", "Phone", "PhoneNumber", "PhoneNumberConfirmed", "RoleId", "SecurityStamp", "SettingId", "TwoFactorEnabled", "UpdatedDate", "UserGuid", "UserImagePath", "UserName" },
                values: new object[,]
                {
                    { 1, 0, "Turkey", null, "b3c83231-390f-4ed3-85c4-ab7ac69ee8c7", new DateTime(2023, 12, 31, 13, 59, 39, 905, DateTimeKind.Local).AddTicks(2675), null, "admin@test.com", false, "Admin", true, "Admin", false, null, null, null, "AQAAAAIAAYagAAAAEMrpAMxKi3YfY9kj3+4uQqHQU+hh+Tmmzp2O2chJ690tKnUecCy3XcYAWETEyvvkJg==", null, "9050", null, false, 1, null, null, false, null, new Guid("6b4256ca-e89b-4b5e-a725-93a610797f50"), "admin.jpg", "admin" },
                    { 2, 0, "Turkey", null, "d3d4524c-855c-4f85-bbcc-d5a9fb7dab60", new DateTime(2023, 12, 31, 13, 59, 39, 950, DateTimeKind.Local).AddTicks(7771), null, "moderator@test.com", false, "Moderator", true, "Moderator", false, null, null, null, "AQAAAAIAAYagAAAAENZeJHVpLqUCz3vTTSgT1ShYhS0uBT4phJSn5CdysaubV2Jeuh6Ql5E3hb8l7dILpA==", null, "9050", null, false, 2, null, null, false, null, new Guid("2c3c313b-6000-450b-a469-53c75989c964"), "moderator.jpg", "moderator" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertRatings_UserId_AdvertId",
                table: "AdvertRatings",
