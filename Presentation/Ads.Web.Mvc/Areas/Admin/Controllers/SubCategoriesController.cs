    ...
    public class SubCategoriesController : Controller
  {
    ...
    public async Task<IActionResult> DetailsAsync(int id)
    {
      try
      {
        ...
        LoggerHelper.LogInformation("Alt kategori detayları başarıyla getirildi.  {SubCategoryId}", id);
        return View(model);
      }
      catch (Exception ex)
      {
        LoggerHelper.LogError(ex, "Alt kategori detayları getirilirken bir hata oluştu.  {SubCategoryId}", id);
        throw;
      }
    }
